...
def certification_blueprint():
    ...
    def desktop():
        ...
        vendors = {
            entry["make"]: entry
            for entry in desktop_data.get("objects")
            + laptop_data.get("objects")
        }.values()
